    ...
    <main className="w-full min-h-screen max-h-screen overflow-hidden grid grid-rows-2 relative">
      ...
      <div className="absolute w-full flex flex-col items-center">
        ...
        <section className="flex gap-5 mt-4">
          <article className="bg-white p-5 rounded-md shadow-md flex flex-col gap-2 ring-1 ring-slate-200 hover:scale-110 hover:ring-indigo-500 cursor-pointer transition-all duration-150 ease-in-out">
            <Image
              src="/devs/yasuri.jpg"
              alt="Yasuri"
              width={200}
            ...
            />
            <h1 className="text-slate-700 font-bold text-center">
              Eira Yasuri Garcia Gonzales
            </h1>
            <p className="text-slate-700 text-center">u20180744</p>
            <h5 className="text-white text-center bg-indigo-500 p-1 rounded-md font-medium">
              Frontend
            </h5>
          </article>
          <article className="bg-white p-5 rounded-md shadow-md flex flex-col gap-2 ring-1 ring-slate-200 hover:scale-110 hover:ring-indigo-500 cursor-pointer transition-all duration-150 ease-in-out">
